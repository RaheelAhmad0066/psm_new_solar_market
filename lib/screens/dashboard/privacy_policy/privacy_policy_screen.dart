...
class _PrivacyPolicyScreenState extends State<PrivacyPolicyScreen> {
  ...
  String _currentPrivacyPolicy = ""; // Stores the current privacy policy
  ...
  // Fetch the current privacy policy from Firestore
  Future<void> _fetchPrivacyPolicy() async {
    ...
    try {
      ...
      if (doc.exists) {
        setState(() {
          _currentPrivacyPolicy = doc['content'];
        });
      }
    } catch (e) {
  ...
  Widget _buildPrivacyPolicyContent() {
    final List<String> policySections = _currentPrivacyPolicy.split('\n\n');
