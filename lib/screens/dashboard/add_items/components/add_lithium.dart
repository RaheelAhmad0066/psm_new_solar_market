...
import 'package:solar_market/controllers/lithium/add_lithium_controller.dart';
...
class AddLithium extends StatefulWidget {
  const AddLithium({super.key});

  @override
  State<AddLithium> createState() => _AddLithiumState();
}

class _AddLithiumState extends State<AddLithium> {
  final AddLithiumController addPanelController =
      Get.put(AddLithiumController());
  ...
  Future<void> fetchBrands() async {
    try {
      QuerySnapshot snapshot =
          await _db.collection('batteryBrands').orderBy('brandNumber').get();
      if (mounted) {
        setState(() {
          brands =
                ...
                : Center(
                    child: RoundButton(
                        onPressed: () {
                          ...
                          addPanelController.addLithium(
                              userPhoneNumber:
                                  profileController.userPhone.value,
                              lthiumData: lthiumData,
                              context: context);
                        },
                        text: 'Submit'))),
            const SizedBox(
