...
import '../screens/dashboard/detail_screens/user_detail_screen.dart';
import '../screens/dashboard/panels/panel_detail_screen.dart';
import '../utils/get_server_key.dart';
...
//
  ...
  Future<void> handleMessage(
    ...
    String subCollection = message.data['subCollection'] ?? '';
    String userId = message.data['userId'] ?? '';

    // Navigate to the BiddingScreen with the required parameters

    if (message.data['screen'] == 'bidding') {
    ...
    } else if (message.data['screen'] == 'userDetail') {
  ...
  static Future<void> sendNotificationUsingApi({
    ...
    String url =
        "https://fcm.googleapis.com/v1/projects/paksolarmarkt/messages:send";
